  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 md:mt-28 lg:px-8">
      <div className="prose prose-lg max-w-none">
        ...
        <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Terminology</h2>
        <p className="text-gray-700 mb-6">
        ...
        <p className="text-gray-700 mb-6">
          We employ the use of cookies. By accessing our website, you agree to use cookies in agreement with our Privacy Policy. Most interactive websites use cookies to let us retrieve the user's details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.
        </p>

        <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Intellectual Property</h2>
        <p className="text-gray-700 mb-6">
          Unless otherwise stated, we and/or our licensors own the intellectual property rights for all material on our website. All intellectual property rights are reserved. You may access this from our website for your personal use subject to restrictions set in these terms and conditions.
        </p>

        <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">User Comments</h2>
        <p className="text-gray-700 mb-6">
          Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. We do not filter, edit, publish, or review Comments before their presence on the website. Comments do not reflect the views and opinions of our company, its agents, and/or affiliates. Comments reflect the views and opinions of the person who posts their views and opinions.
        </p>
        ...
        <p className="text-gray-700 mb-6">
          For any questions regarding our terms, please contact <a href="mailto:israelitesshopping171@gmail.com" className="text-blue-600 hover:text-blue-800">israelitesshopping171@gmail.com</a>.
        </p>
      </div>
    </div>
  );
